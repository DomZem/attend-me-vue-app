...
import { ApiClientBase, type DeviceRegisterDTO, type TokenResult } from './api-client-base';
...
export class ApiClient extends ApiClientBase {
	...
	private fetchWrapper(requestInfo: RequestInfo, init?: RequestInit): Promise<Response> {
		...
		if (
			this.deviceTokenResult &&
			(path.startsWith('/user/device/register') || path.startsWith('/user/attendance/ticket/get') || path.startsWith('/course/session/attendance/register')) &&
