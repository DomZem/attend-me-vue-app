...
export class ApiClientBase {
	...
	attendergroupMemberAdd(attenderGroupId: number | undefined, userId: number | undefined): Promise<AttenderGroup> {
		...
		else if (attenderGroupId !== undefined) url_ += 'attenderGroupId=' + encodeURIComponent('' + attenderGroupId) + '&';
	...
	courseGroupAttenderUserAdd(courseGroupId: number | undefined, userId: number | undefined): Promise<void> {
		...
		else if (courseGroupId !== undefined) url_ += 'courseGroupId=' + encodeURIComponent('' + courseGroupId) + '&';
		if (userId === null) throw new Error("The parameter 'userId' cannot be null.");
		else if (userId !== undefined) url_ += 'userId=' + encodeURIComponent('' + userId) + '&';
		url_ = url_.replace(/[?&]$/, '');
	...
	courseGroupTeacherAssign(courseGroupId: number | undefined, teacherUserId: number | undefined): Promise<void> {
		...
		else if (teacherUserId !== undefined) url_ += 'teacherUserId=' + encodeURIComponent('' + teacherUserId) + '&';
		url_ = url_.replace(/[?&]$/, '');
	 ...
	 * @return Success
	 */
	courseSessionAttendanceScannerSessionTokenGet(courseSessionId: number | undefined): Promise<StringActionResult> {
		let url_ = this.baseUrl + '/course/session/attendance/scanner-session/token/get?';
		if (courseSessionId === null) throw new Error("The parameter 'courseSessionId' cannot be null.");
		else if (courseSessionId !== undefined) url_ += 'courseSessionId=' + encodeURIComponent('' + courseSessionId) + '&';
		url_ = url_.replace(/[?&]$/, '');
		...
		return this.http.fetch(url_, options_).then((_response: Response) => {
			return this.processCourseSessionAttendanceScannerSessionTokenGet(_response);
		});
	}

	protected processCourseSessionAttendanceScannerSessionTokenGet(response: Response): Promise<StringActionResult> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v));
		...
		if (status === 200) {
			return response.text().then((_responseText) => {
				let result200: any = null;
				result200 = _responseText === '' ? null : (JSON.parse(_responseText, this.jsonParseReviver) as StringActionResult);
				return result200;
			});
		} else if (status !== 200 && status !== 204) {
			return response.text().then((_responseText) => {
		...
		return Promise.resolve<StringActionResult>(null as any);
	}
	 ...
	 * @return Success
	 */
	courseSessionAttendanceRegister(attenderToken: string | undefined): Promise<StringActionResult> {
		...
		else if (attenderToken !== undefined) url_ += 'attenderToken=' + encodeURIComponent('' + attenderToken) + '&';
		url_ = url_.replace(/[?&]$/, '');
	...
	protected processCourseSessionAttendanceRegister(response: Response): Promise<StringActionResult> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v));
	 ...
	 * @return Success
	 */
	userLogin(loginName: string | undefined, password: string | undefined): Promise<LoginResult> {
		let url_ = this.baseUrl + '/user/login?';
		if (loginName === null) throw new Error("The parameter 'loginName' cannot be null.");
		else if (loginName !== undefined) url_ += 'loginName=' + encodeURIComponent('' + loginName) + '&';
	...
	protected processUserLogin(response: Response): Promise<LoginResult> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v));
	 ...
	 * @return Success
	 */
	userDeviceRegisterTokenGet(deviceUserId: number | undefined): Promise<string> {
		...
		else if (deviceUserId !== undefined) url_ += 'deviceUserId=' + encodeURIComponent('' + deviceUserId) + '&';
		url_ = url_.replace(/[?&]$/, '');
	...
	protected processUserDeviceRegisterTokenGet(response: Response): Promise<string> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v));
	 ...
	 * @return Success
	 */
	userDeviceRegister(deviceName: string | undefined): Promise<string> {
		let url_ = this.baseUrl + '/user/device/register?';
		if (deviceName === null) throw new Error("The parameter 'deviceName' cannot be null.");
		else if (deviceName !== undefined) url_ += 'deviceName=' + encodeURIComponent('' + deviceName) + '&';
		url_ = url_.replace(/[?&]$/, '');
	 ...
	 * @return Success
	 */
	userGet(userId: number | undefined, id: string): Promise<User> {
	 ...
	 * @return Success
	 */
	userAttendanceTicketGet(): Promise<StringActionResult> {
	...
	protected processUserAttendanceTicketGet(response: Response): Promise<StringActionResult> {
		const status = response.status;
		let _headers: any = {};
		if (response.headers && response.headers.forEach) {
			response.headers.forEach((v: any, k: any) => (_headers[k] = v));
