...
export class ApiClientBase {
	...
	courseSessionAttendanceToggle(attendingUserId: number | undefined, courseSessionId: number | undefined, addOrRemove: boolean | undefined): Promise<AttendanceLog[]> {
		...
		else if (attendingUserId !== undefined) url_ += 'attendingUserId=' + encodeURIComponent('' + attendingUserId) + '&';
		if (courseSessionId === null) throw new Error("The parameter 'courseSessionId' cannot be null.");
		else if (courseSessionId !== undefined) url_ += 'courseSessionId=' + encodeURIComponent('' + courseSessionId) + '&';
		if (addOrRemove === null) throw new Error("The parameter 'addOrRemove' cannot be null.");
		else if (addOrRemove !== undefined) url_ += 'addOrRemove=' + encodeURIComponent('' + addOrRemove) + '&';
		url_ = url_.replace(/[?&]$/, '');
